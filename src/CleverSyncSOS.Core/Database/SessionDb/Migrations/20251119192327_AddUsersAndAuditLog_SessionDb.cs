...
{
    /// <inheritdoc />
    public partial class AddUsersAndAuditLog_SessionDb : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthenticationSource = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    SchoolId = table.Column<int>(type: "int", nullable: true),
                    DistrictId = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    CleverUserId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_AuthenticationSource",
                table: "Users",
                column: "AuthenticationSource");

            migrationBuilder.CreateIndex(
                name: "IX_Users_CleverUserId",
                table: "Users",
                column: "CleverUserId");
