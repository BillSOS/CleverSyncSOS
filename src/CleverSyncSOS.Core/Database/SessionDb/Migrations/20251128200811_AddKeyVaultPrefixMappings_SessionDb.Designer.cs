...
namespace CleverSyncSOS.Core.Database.SessionDb.Migrations
{
    ...
    [Migration("20251128200811_AddKeyVaultPrefixMappings_SessionDb")]
    partial class AddKeyVaultPrefixMappings_SessionDb
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CleverSyncSOS.Core.Database.SessionDb.Entities.School", b =>
                {
                    ...
                    b.Property<string>("SchoolPrefix")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
