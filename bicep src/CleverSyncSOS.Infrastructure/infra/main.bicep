// infra/main.bicep
// Deploys a serverless Function App on a Consumption Plan targeting .NET 9
...
resource functionApp 'Microsoft.Web/sites@2022-03-01' = {
  ...
  properties: {
    ...
    siteConfig: {
      // UPDATED: Target .NET 9 via app settings for Consumption Plan
      appSettings: [
        {
